...
const Beauticians = () => {
  ...
  const access = {
    beauticiansMenu: permissionsData?.beauticianSettings?.[0],
  };

  const beauticianPermission = access?.beauticiansMenu;
  ...
  useEffect(() => {
    if (beauticianPermission?.falsecount !== 3) {
      fetchTableData(tableData);
    } else {
      navigate(-1);
    }
        ...
        value: (
          <div className="text-start d-flex align-items-center gap-2 pointer">
            <div className="d-flex align-items-center gap-3">
              {beauticianPermission?.viewAndDownload && (
                <RoundCheckBox
                  id={_id}
                ...
                <Dropdown align="start">
                  ...
                  <DropdownMenu>
                    {workHours?.dayDetails.map((elm, i) => {
                      ...
                      return (
                        <DropdownItem className="" key={i}>
                          <div className="d-flex justify-content-between text-13-500 color-black-20 gap-2">
            ...
            {beauticianPermission?.all && (
              <>
                ...
                <Button
                  ...
                  btnStyle="PLO"
                  leftIcon={
                    <img src={icons.addSquareBlack} alt="add-beautician" />
                  }
                  onClick={() => {
