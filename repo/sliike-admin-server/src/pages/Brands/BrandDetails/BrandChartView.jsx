  ...
  return (
    <>
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="border cpt-20 cps-24 cpe-24 cpb-20 rounded h-100">
            ...
            <div className="mt-2 d-flex justify-content-between align-items-center">
              ...
              <span className="text-13-600 color-dashboard-primary">5,200</span>
            </div>
            ...
            <div className="mt-2 d-flex justify-content-between align-items-center">
              ...
              <span className="text-13-600 color-dashboard-primary">800</span>
            </div>
            <div className="mt-2 d-flex justify-content-between align-items-center">
              <div className="d-flex gap-2 align-items-center">
                <span>
              ...
              <span className="text-13-600 color-dashboard-primary">2000</span>
            </div>
          </div>
        </div>
      </div>
